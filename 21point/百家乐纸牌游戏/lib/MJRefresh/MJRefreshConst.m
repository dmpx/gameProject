...
NSString *const TYXRefreshFooterPullToRefresh = @"上拉查看图文详情";
NSString *const TYXRefreshFooterReleaseToRefresh = @"松开立即加载图文详情";
NSString *const TYXRefreshFooterRefreshing = @"正在加载···";

NSString *const TYXRefreshHeaderPullToRefresh = @"下拉回到商品详情";
NSString *const TYXRefreshHeaderReleaseToRefresh = @"";
NSString *const TYXRefreshHeaderRefreshing = @"";