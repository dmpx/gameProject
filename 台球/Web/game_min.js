FZ = {
	...
	showMsg : function (a) {
		var b = [SpilGames._("轮到玩家1"), SpilGames._("轮到玩家2"), SpilGames._("轮到电脑")],
		c;
		switch (vs) {
		case "pvp":
			a ? c = 0 : c = 1;
...
(window), function (a, b) {
	...
	co = function (a) {
		D.HAS_PUBLIC_API ? SpilGames.Highscores.showScoreboard() : alert(SpilGames._("排行榜: %s", cn()))
	},
	cp = function () {
		...
		return {
			...
			"class" : {
				...
				":Button" : {
					...
					init : function () {
						...
						case "start":
							...
							break;
						case "statistic":
							this.setText(SpilGames._("游戏成绩"));
							break;
						case "rule":
							this.setText(SpilGames._(""));
							break;
						case "htp":
							this.setText(SpilGames._("游戏帮助"));
							break;
						case "prev":
							this.setText("&lt;&lt;");
							break;
						case "next":
							...
							break;
						case "reset":
							this.setText(SpilGames._("重置"));
							break;
						case "return":
							this.setText(SpilGames._("返回"));
							break;
						case "continue":
							this.setText(SpilGames._("继续"));
							break;
						case "restart":
							this.setText(SpilGames._("重新开始"));
							break;
						case "menu":
							this.setText(SpilGames._("主菜单"));
							break;
						case "pauseBtn":
							this.setText("||");
							break;
						case "again":
							this.setText(SpilGames._("再来一次"))
						}
				...
				":Statistic" : {
					...
					init : function () {
						c.connect(this, "scene"),
						this.findChild("title").setText(SpilGames._("游戏成绩")),
						this.mode = this.findChild("mode"),
						this.mode.setText(SpilGames._("- 美式8球 -")),
					...
					reset : function () {
						...
						switch (b) {
						case "8ball.pvc":
							if (a.confirm(SpilGames._("清除美式8球数据!")) !== !0)
								return;
						...
						case "8ball.pvp":
							...
							break;
						case "straight.pvc":
							if (a.confirm(SpilGames._("清除斯诺克数据!")) !== !0)
								return;
					...
					setStatistic : function (a) {
						...
						case "8ball.pvp":
							...
							break;
						case "straight.pvc":
							this.mode.setText(SpilGames._("- 斯诺克 -")),
							b = "Computer",
						...
						this.content.setText(SpilGames._("<table><tr><td style='width:110px;'></td><td style='width:75px;'>玩家1</td><td style='width:75px;'>%s</td></tr><tr><td>游戏胜利</td><td>%s</td><td>%s</td></tr><tr><td>游戏失败</td><td>%s</td><td>%s</td></tr><tr><td>百分比</td><td>%s%</td><td>%s%</td></tr></table>", b + "", d[0] + "", d[1] + "", d[1] + "", d[0] + "", (d[0] / (d[0] + d[1]) * 100 << 0) + "", (d[1] / (d[0] + d[1]) * 100 << 0) + "")),
				...
				":Rule" : { 
					init : function () {  
						c.connect(this, "scene"),
						this.findChild("title").setText(SpilGames._("游戏规则")),
						this.findChild("title1").setText(SpilGames._("美式8球:")),
						this.findChild("content1").setText(SpilGames._("把所有的球都击入洞中，但是要保留最后一个球是黑8!")),
						this.findChild("title2").setText(SpilGames._("斯诺克:")),
						this.findChild("content2").setText(SpilGames._("争取第一个击中9号球入洞!")) 
					},
					scene : function () {} 			
				},
				":Mode" : {
					init : function () {
						c.connect(this, "scene"),
						this.findChild("8ball").setText(SpilGames._("- 美式8球 -")),
						this.findChild("straight").setText(SpilGames._("- 斯诺克 -"))
					},
					scene : function () {}
				...
				":Main" : {
					...
					prescene : function (b, c, d) {
						if (b === !0) {
							switch (c) {
							case "8ballpvc":
								this.m_title.setText(SpilGames._("美式8球")),
							...
							case "8ballpvp":
								...
								break;
							case "straightp":
								this.m_title.setText(SpilGames._("斯诺克")),
								this.m_player1.__view__.className = "player1_head",
				...
				":Table" : {
					...
					enterTutorials : function () {
						...
						this.m_tutorialsHandle = c.setTimeout(function () {
								...
								case 0:
									d === 0 ? (f.setVisible(!0), m = h / 2, n = i / 2, a.mousedown(m - o, n - p), d = 1, g.setVisible(!0), g.setText(SpilGames._("调整击杆的方向。<br /><span style='color: red;'>按任意键继续</span>"))) : (m = h / 2, n = i / 2 - Math.sin(l * .1 * e) * 20, a.mousemove(m - o, n - p));
									break;
								case 1:
									d === 1 ? (a.mousemove(h / 2 - o, i / 2 - p), a.mouseup(!0), m = h / 2, n = i / 2, a.mousedown(m - o, n - p), b = c.getTime(), d = 2, g.setText(SpilGames._("微调角度。<br /><span style='color: red;'>按任意键继续</span>"))) : (m = h / 2, n = i / 2 - Math.sin(l * .1 * e) * 30, a.mousemove(m - o, n - p));
									break;
								case 2:
									d === 2 ? (a.mousemove(h / 2 - o, i / 2 - p), a.mouseup(!0), m = h / 2, n = i / 2, a.mousedown(m - o, n - p), b = c.getTime(), d = 3, g.setText(SpilGames._("瞄准球<br /><span style='color: red;'>按任意键继续</span>"))) : (m = h / 2 - (Math.sin(l * .1 * e) + 1) * 80, n = i / 2, a.mousemove(m - o, n - p));
									break;
								case 3:
				...
				":Pause" : {
					init : function () {
						c.connect(this, "scene"),
						this.findChild("title").setText(SpilGames._("暂停"))
					},
					scene : function () {}
					...
					prescene : function (a, b, d) {
						if (a === !0) {
							...
							case "8ballpvc":
								...
								this.m_title.setText(d === 1 ? SpilGames._("你赢了") : SpilGames._("你败了"));
                         hello2gameAPI("^^");
								break;
							case "8ballpvp":
								c.global.g8ball.pvp[d - 1]++,
								this.m_title.setText(d === 1 ? SpilGames._("玩家1赢了") : SpilGames._("玩家2赢了"));
                         hello2gameAPI("^^");
								break;
							case "straightp":
								this.m_title.setText(SpilGames._("干得不错！"));
                         hello2gameAPI("^^");
								break;
							case "straightpvc":
