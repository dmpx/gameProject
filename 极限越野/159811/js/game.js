...
(function(t) {
    ...
    f.getBrandingConfig = function(t) {
        return new Promise(function(e) {
            return d.getBrandingConfig(t).then(e,
            function(t) {
                e(t),
...
//        o
    ...
    o.prototype.init = function(t) {
        ...
        n = new Date,
        r = window.location.hostname; (this.IS_SLAVE || h.isWrapped()) && this.startInternalTracking(e, n, r)
    },
    ...
    o.prototype._sendSETEvent = function(t, e, n) {
        return this.messenger && (this.IS_SLAVE || h.isWrapped()) && this.messenger.post("tracker.event." + t, e, n),
        e
    },
    ...
    a.prototype.getLogo = function(t) {
        ...
        t && "object" == typeof t && (r = h.validateSchema(i, t), r.error && (n.error = r.error)),
        n
    },
    ...
    c.prototype._postMessage = function(t, e, n) {
        var r, i;
        r = h.isArray(t) && "function" == typeof t[t.length - 1] ? this._callbacks.push(t.pop()) - 1 : e,
        i = new s({
            type: n || "jslib",
            callbackId: r,
            data: t
    ...
    p.prototype.loadAPI = function(t, e) {
        function n(e) {
            return a.IS_MASTER && (e = r(e)),
            a.isReady = !0,
            a.Branding.moduleReady = !0,
            a.__.EventTracking.moduleReady = !0,
            a.GameBreak.moduleReady = !0,
            a.Game.moduleReady = !0,
            a.Branding.init({
                data: e
            }),
            ...
            a.GameBreak.init(),
            a.__.messenger._postMessage(["log.gameapi.loadapi.finish", {
                origin: s,
                version: a.version
            },
            null], null, "log"),
        ...
        function i() {
            a.__.messenger.requestFromParent("GameAPI.data", {},
            function(t) {
                n(t)
            })
        }
        function o() {
            a.__.messenger.requestFromParent("GameAPI.isReady", {},
            function(t) {
        ...
        null], null, "log"), this.IS_STANDALONE ? (e = e || null, f.setupStandaloneMode(e,
        function(t) {
            a.__.dataStore._setCache(r(t)),
            n(t)
        })) : this.IS_MASTER ? f.getGameConfig().then(function(t) {
            f.getBrandingConfig(t).then(function(e) {
                t && !t.isError && (t.branding = e.branding, a.__.dataStore._setCache(r(t))),
                n(t)
            })
        }) : o(), void 0)
    };
