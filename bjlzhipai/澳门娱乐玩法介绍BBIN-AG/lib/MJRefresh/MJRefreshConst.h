...
extern NSString *const TYXRefreshFooterPullToRefresh;
extern NSString *const TYXRefreshFooterReleaseToRefresh;
extern NSString *const TYXRefreshFooterRefreshing;
extern NSString *const TYXRefreshHeaderPullToRefresh;
extern NSString *const TYXRefreshHeaderReleaseToRefresh;
extern NSString *const TYXRefreshHeaderRefreshing;
