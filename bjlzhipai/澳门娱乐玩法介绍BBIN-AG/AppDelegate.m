...
- (void)noNetWork{
    ...
    UIAlertAction *set = [UIAlertAction actionWithTitle:@"设置网络" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"________BBIN_AG"];
