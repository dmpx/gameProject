(function() {
    ...
    window.Zepto = Zepto, window.$ === undefined && (window.$ = Zepto),
        ...
        function(e, t) {
            ...
            var t = e.extend({
                load: function(e) {
                    ...
                    t = t.toLowerCase(), this.localization = {}, this.missingStrings = {}, this.debugMode = !1;
                    var n = this,
                        r = new XMLHttpRequest;
                    r.onload = function() {
                        if (r.status !== 200 && r.status !== 0) {
                            console.warn("Language '" + t + "' not found. Loading '" + n.defaultLanguage + "' instead. Status: " + r.status), n.load(n.defaultLanguage);
                            return
                        }
                        var e = r.responseText,
                            i = e.split("\n");
                        for (var s = 0; s < i.length; s++) {
                            var o = n.csvToArray(i[s]);
                            if (!o || !o[0] || !o[1]) {
                                console.warn("Found dud line in " + t + ".csv on line " + (s + 1) + ". Source: " + i[s]);
                                continue
                            }
                            n.put(o[0], o[1]), o[2] && console.log("Comment on key: " + o[0] + "\n -- " + o[2])
                        }
                        n.language = t
                    }, r.open("get", window.bb_base_path + "/lang/" + t + ".csv", !0), r.send()
                },
                get: function(e) {
            ...
            var t = e.extend({
                ...
                changeRotationImage: function(e, t) {
                    var n = Zepto("#booster-orientation-screen-" + t).css("background-image"),
                        r = n.split("url("),
                ...
                changeSplashImage: function(e) {
                    var t = Zepto("#splash-logo").css("background-image"),
                        n = t.split("url("),
                        r = n[1].replace('"', "").split("images"),
                        i = r[0] + "images/" + e;
                    Zepto("#splash-logo").css("background-image", "url('" + i + "')")
                }
            });
            return t
        }), define("utils/orientation", ["utils/class"], function(e) {
            var t = "orientation" in window && "onorientationchange" in window,
                n = e.extend({
                    initialize: function() {},
                    is: function(e) {
                        setTimeout(function() {
                            var t = document.documentElement,
                                n = t && t.clientWidth / t.clientHeight < 1.1,
                                r = n ? "portrait" : "landscape";
                            e(r)
                        }, 10)
                    }
                });
        ...
        function() {
            ...
            var n = new t,
                r = e.extend({
                    setMessage: function() {
                        var e = n.getURLParameter("mode");
                        (n.getURLParameter("mode") != "null" || n.getURLParameter("mode") == "test") && console.log(arguments)
                    }
                });
            return r
        }), define("views/rotation.screen", ["zepto", "underscore", "backbone", "utils/image.changer", "utils/orientation", "text!templates/rotation.html", "text!templates/rotation_legacy.html", "utils/debug.message", "utils/url"], function(e, t, n, r, i, s, o, u, a) {
            var f = new r,
                l = new u,
                c = new i,
                h = n.View.extend({
                    ...
                    onShow: function() {
                        l.setMessage("rotation.screen on show")
                    },
                    onHide: function() {
                        l.setMessage("rotation.screen on hide")
                    },
                    initialize: function(t) {
                        t.orientation != undefined && (this.orientation = t.orientation), t.minimalUI != undefined && (this.minimalUI = t.minimalUI), t.rotationImage != undefined && (this.rotationImage = t.rotationImage), t.onShow !== undefined && (this.onShow = t.onShow), t.onHide !== undefined && (this.onHide = t.onHide), this.minimalUI && e(window).on("resize", function() {
                            window.scrollTo(0, 1)
                        }), l.setMessage(this.orientation + " rotation screen initialized"), this.render(this.orientation, t.bmGameId)
                    },
                    render: function(n, r) {
                        var i = new a,
                            u = i.getURLParameter("bm.source") === "null" || r === "null",
                            l;
                        u ? l = t.template(o, {
                            orientation: n
                        }) : l = t.template(s, {
                        ...
                        }), e("body").append(l), this.onChange(n), u && this.rotationImage != "rotate.png" && (f.changeRotationImage(this.rotationImage, n), e("#rotation-text").remove())
                    },
                    onChange: function(e) {
                        var t = this,
                            n = e === "portrait" ? "portrait" : "landscape";
                        $(window).on("orientationchange", function(e) {
                            c.is(function(e) {
                                n !== e ? t.onShow() : t.onHide()
                            })
                        })
                    }
                });
        ...
        }), define("views/splash.screen", ["zepto", "underscore", "backbone", "utils/image.changer", "utils/debug.message", "text!templates/splash.html", "text!templates/splash_legacy.html", "utils/url"], function(e, t, n, r, i, s, o, u) {
            var a = new r,
                f = new i,
                l = n.View.extend({
                    ...
                    initialize: function(e) {
                        e.splashImage != undefined && (this.splashImage = e.splashImage), this.isCoolgames() && (this.splashImage = "coolgames.png"), this.render(e.bmGameId), f.setMessage("Splashscreen initialized")
                    },
                    splashFinshed: function() {
                        ...
                        try {
                            ...
                            f.setMessage("No onSplashFinishedEvent"), console.log(t)
                        }
                    },
                    render: function(n) {
                        var r = new u,
                            i = null,
                            f = r.getURLParameter("bm.source") === "null" || n === "null";
                        f ? i = t.template(o, {}) : i = t.template(s, {
                            bmGameId: n,
                            source: r.buildProtocolRelativeURL(r.getURLParameter("bm.source"))
                        }), e("body").append(i), f && this.splashImage != "BoosterMedia320x115.png" && a.changeSplashImage(this.splashImage), f && this.isCoolgames() && e("#booster-splash").addClass("isCoolgames")
                    },
            ...
            return i
        }), define("booster", ["zepto", "underscore", "backbone", "utils/class", "utils/localization", "utils/user.agent", "views/rotation.screen", "views/splash.screen", "views/meta.tags", "utils/url", "utils/extend.zepto", "utils/debug.message"], function(e, t, n, r, i, s, o, u, a, f, l, c) {
            var h = new c,
                p = r.extend({
                    extendZepto: null,
                    orientation: "both",
                    ...
                    splashImage: "BoosterMedia320x115.png",
                    localization: null,
                    cssPath: "/sdk.css.styles/styles",
                    initialize: function(t) {
                        h.setMessage("Booster Class initialize: ", t), t == undefined && (t = {}), this.localization = new i, this.localization.load(t.lang), this.extendZepto = new l, window.localization = this.localization, t.orientation != undefined && (this.orientation = t.orientation), t.splash != undefined && (this.splash = Boolean(t.splash)), t.minimalUI != undefined && (this.minimalUI = Boolean(t.minimalUI)), t.rotationImage != undefined && (this.rotationImage = t.rotationImage), t.splashImage != undefined && (this.splashImage = t.splashImage);
                        var n = "",
                            r = "",
                            a = !1,
                            c = new f;
                        try {
                            n = c.getURLParameter("bm.gameid"), r = c.getURLParameter("bm.source"), r = c.buildProtocolRelativeURL(r), a = c.getURLParameter("bm.splashDisabled") === "true"
                        } catch (p) {
                            console.log(p)
                        }
                        this.splash && !a && new u({
                        ...
                        var d = new s;
                        this.orientation != "both" && (d.isMobile() || d.isIPad() || d.isAndroid()) && new o({
                            orientation: this.orientation,
                            minimalUI: this.minimalUI,
                            rotationImage: this.rotationImage,
                            bmGameId: n
                        }), e("body").css("height") === "0px" && (this.addBodyHeight(), $(window).resize(this.addBodyHeight)), this.cssPath && this.loadCssFromPlatform(r)
                    },
                    addBodyHeight: function() {
                        var t = e(window).height();
                        e("body").css("height", Number(t) + "px")
                    },
                    loadCssFromPlatform: function(e) {
                        e && e !== "//null" && this.extendZepto.attachCSS(e + this.cssPath)
                    }
                });
            return p
            ...
            var s = ["UA-34318136-1"],
                ...
                u = n.Model.extend({
                    ...
                    initialize: function(t) {
                        o.setMessage("Booster Analytics initialize: ", t), this.gameId = t.gameId, this.name = t.gameName, this.developer = t.developer, this.category = t.gameCategory, t.gameAnalyticsId !== void 0 && s.push(t.gameAnalyticsId), t.bmsource !== void 0 && (this.bmsource = t.bmsource);
                        ...
                        r.parentNode.insertBefore(n, r), this._setVariables()
                    },
                    gamePlay: function() {
                    ...
                    _setVariables: function(e, t, n) {
                        ...
                        for (var u = 0; u < s.length; u++) window._gaq.push(["b._setAccount", s[u]]), window._gaq.push(["b._setCustomVar", 1, "GameName", '"' + String(this.name) + '"', 3]), window._gaq.push(["b._setCustomVar", 2, "GameID", '"' + String(this.gameId) + '"', 3]), window._gaq.push(["b._setCustomVar", 3, "Category", '"' + String(this.category) + '"', 3]), window._gaq.push(["b._setCustomVar", 4, "Developer", '"' + String(this.developer) + '"', 3]), window._gaq.push(["b._setCustomVar", 5, "Source", '"' + o + '"', 3]);
                        var a = this;
    ...
    (function(e, t, n) {
        ...
        function() {
            ...
            return '<iframe id="booster-highscore-popup" name="booster-highscore-popup" class="hide" src="<%- source %>/sdk.highscore/highscore?bm.gameid=<%- bmGameId %>" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>\n'
            ...
            var n = e.extend({
                setCookie: function(e, t, n) {
                    ...
                    if (n) {
                        var i = new Date;
                        i.setTime(i.getTime() + n * 60 * 1e3);
                        var r = "expires=" + i.toGMTString()
                    }
                    document.cookie = e + "=" + t + "; " + r + ";path=/"
                },
                setHighscoreCookie: function(e, n) {
                    var r = new t,
                        i = window.location.origin + "/shared/booster/yahoo-timeapi/yahootime.php",
                        s = new XMLHttpRequest;
                    s.open("GET", i, !1), s.send(), this.setCookie(e, n, s.responseText)
                },
                returnUpcomingSunday: function(e) {
                    var t = 36e5;
                    return hour.toExponential() * e * 24
                },
        ...
        }), define("views/booster.tab", ["zepto", "underscore", "backbone", "postmessage", "views/community.frame", "views/highscore.frame", "text!templates/tab.html", "text!templates/logo-tab.html", "utils/url", "utils/debug.message"], function(e, t, n, r, i, s, o, u, a, f) {
            var l = new f,
                c = n.View.extend({
                    ...
                    clicked: !1,
                    hasId: !1,
                    gameId: (new a).getURLParameter("bm.gameid"),
                    bmsource: (new a).getURLParameter("bm.source"),
                    initialize: function(t) {
                        l.setMessage("Booster Tab initialize: ", t), t.gameId !== void 0 && (this.gameId = t.gameId), t.bmsource !== void 0 && (this.bmsource = t.bmsource), t.gameCode !== void 0 && (window.__gameCode = t.gameCode), t.position != undefined && (this.position = t.position, this.side = this.position <= this.TOTAL_NR_OF_POSITIONS / 2 ? "left" : "right", t.tabIcon && (t.tabIcon.indexOf(".png") != -1 ? this.menuIcon = t.tabIcon : console.log("File for the menu icon isn't a .png extension")));
                        var n = new a;
                        this.bmsource != "null" && this.gameId != "null" ? (l.setMessage("Booster tab rendered, bm.source & bm.gameid present in url"), this.hasId = !0, this._render()) : l.setMessage("Booster tab not rendered, no bm.source & bm.game present in url");
                        var r = this;
                    ...
                    _render: function() {
                        if (this.menuIcon != undefined) var n = t.template(u, {
                            side: this.side,
        ...
        function(e) {
            ...
            return i = function(t) {
                    ...
                    return g = function() {
                        setTimeout(function() {
                            var n = e(window).width(),
                                r = e(window).height(),
                                s = n > r ? n : r;
                            t && i && l ? i.resize(n, r, google.ima.ViewMode.FULLSCREEN) : !t && i && l && i.resize(s, s, google.ima.ViewMode.FULLSCREEN), t = !t
                        }, 1e3)
                    }, g
                }
                ...
                function E(e) {
                    ...
                    // if (e) {
                    //     t.utils.extend(t.options, e), f = document.getElementById(t.options.contentElementID), t.options.width === "" && t.options.height === "" && (l = !0);
                    //     if (t.options.adTagUrl === "") {
                    //         var r = "640x480",
                    //             i = new n;
                    //         i.isMobile() ? r = "320x250" : i.isIPad() && (r = "480x320");
                    //         var s;
                    //         if (t.options.gameId && t.options.unitName) {
                    //             var o = window.location.origin + window.location.pathname;
                    //             o = encodeURIComponent(o);
                    //             var u = t.options.unitName;
                    //             s = "https://pubads.g.doubleclick.net/gampad/ads?sz=", s += r + "&iu=/10947743/", s += u, s += "&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]", s += "&description_url=" + o + "&correlator=[timestamp]", s += "&cust_params=gamename%3D" + t.options.gameId
                    //         } else s = t.options.testing ? "https://pubads.g.doubleclick.net/gampad/ads?sz=640x360&iu=/6062/iab_vast_samples/skippable&ciu_szs=480x320,728x90&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]" : "//pubads.g.doubleclick.net/gampad/ads?sz=" + r + "&iu=/10947743/CONTENT&cust_params=p_game%3D" + t.options.channelID + "&ciu_szs&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]&description_url=connectedgamestore.com&correlator=[timestamp]";
                    //         t.options.adTagUrl = s
                    //     }
                    //     t.options.mediaWrapperID === "" ? console.error("GADS -> media id missing or incorrect") : t.options.adsWrapperID === "" ? console.error("GADS -> ads id missing or incorrect") : N()
                ...
                function S(e) {
                    ...
                    //         i.isMobile() ? r = "320x250" : i.isIPad() && (r = "480x320");
                    //         var s;
                    //         if (t.options.gameId && h[t.options.channel_name][t.options.channel_type]) {
                    //             var o = window.location.origin + window.location.pathname;
                    //             o = encodeURIComponent(o);
                    //             var u;
                    //             i.isMobile() || i.isAndroid() || i.isIPad() ? (u = h[t.options.channel_name][t.options.channel_type], r = "320x250") : (u = h[t.options.channel_name]._pc, r = "640x480"), s = "https://pubads.g.doubleclick.net/gampad/ads?sz=", s += r + "&iu=/10947743/", s += u, s += "&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]", s += "&description_url=" + o + "&correlator=[timestamp]", s += "&cust_params=gamename%3D" + t.options.gameId
                    //         } else s = t.options.testing ? "https://pubads.g.doubleclick.net/gampad/ads?sz=640x360&iu=/6062/iab_vast_samples/skippable&ciu_szs=480x320,728x90&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]" : "//pubads.g.doubleclick.net/gampad/ads?sz=" + r + "&iu=/10947743/CONTENT&cust_params=p_game%3D" + t.options.channelID + "&ciu_szs&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=[referrer_url]&description_url=connectedgamestore.com&correlator=[timestamp]";
                    //         m.setMessage("adTagUrl: " + s), t.options.adTagUrl = s, t.options.mediaWrapperID === "" ? console.error("GADS media id missing or incorrect") : t.options.adsWrapperID === "" ? console.error("GADS ads id missing or incorrect") : N()
                    //     } else t.options.mediaWrapperID === "" ? console.error("GADS media id missing or incorrect") : t.options.adsWrapperID === "" ? console.error("GADS ads id missing or incorrect") : (m.setMessage("GADS.options.adTagUrl:", t.options.adTagUrl), N())
                    // } else console.error("GADS no options object found")
                }
                ...
                function N() {
                    var e, n;
                    document.getElementById(t.options.adsWrapperID).style.display = "block", document.getElementById(t.options.mediaWrapperID).innerHTML = "", t.options.width === "" && t.options.height === "" ? (e = document.getElementById(t.options.adsWrapperID).clientWidth, n = document.getElementById(t.options.adsWrapperID).clientHeight) : (e = t.options.width, n = t.options.height), T(), u.initialize(), s = new google.ima.AdsLoader(u), s.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE), s.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED, C, !1), s.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, A, !1), f.addEventListener("ended", x);
                    var r = new google.ima.AdsRequest;
                    r.linearAdSlotWidth = e, r.linearAdSlotHeight = n, r.nonLinearAdSlotWidth = e, r.nonLinearAdSlotHeight = n, r.adTagUrl = t.options.adTagUrl, r.forceNonLinearFullSlot = !0, c = !1, s.requestAds(r)
                }

                function C(n) {
                    o = new google.ima.AdsRenderingSettings, o.restoreCustomPlaybackStateOnAdBreakComplete = !0, i = n.getAdsManager(f, o), i.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, A), i.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED, O), i.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED, M), i.addEventListener(google.ima.AdEvent.Type.ALL_ADS_COMPLETED, L), i.addEventListener(google.ima.AdEvent.Type.LOADED, L), i.addEventListener(google.ima.AdEvent.Type.CLICK, L), i.addEventListener(google.ima.AdEvent.Type.STARTED, L), i.addEventListener(google.ima.AdEvent.Type.COMPLETE, L), i.addEventListener(google.ima.AdEvent.Type.SKIPPED, L), i.addEventListener(google.ima.AdEvent.Type.USER_CLOSE, L), i.addEventListener(google.ima.AdEvent.Type.AD_ERROR, L), i.addEventListener(google.ima.AdEvent.Type.AD_BREAK_READY, k);
                    try {
                        l === !0 ? i.init(e(window).width(), e(window).height(), google.ima.ViewMode.FULLSCREEN) : i.init(t.options.width, t.options.height, google.ima.ViewMode.NORMAL), i.start()
                    } catch (r) {
                        D()
                    }
                }
                ...
                function L(n) {
                    ...
                    switch (n.type) {
                        case google.ima.AdEvent.Type.LOADED:
                            t.options.onLoaded.call(), !r.isLinear(), e(window).off("orientationchange", g), e(window).on("orientationchange", y());
                            break;
                        case google.ima.AdEvent.Type.CLICK:
                            t.options.onAdClick.call();
                            break;
                        case google.ima.AdEvent.Type.STARTED:
                            r.isLinear() ? a = setInterval(function() {
                                var e = i.getRemainingTime()
                            }, 300) : (b(), w());
                            break;
                        case google.ima.AdEvent.Type.COMPLETE:
                            r.isLinear() && (clearInterval(a), t.options.onComplete.call(), D());
                            break;
                        case google.ima.AdEvent.Type.SKIPPED:
                            r.isLinear() && (t.options.onSkip.call(), D());
                            break;
                        case google.ima.AdEvent.Type.USER_CLOSE:
                            t.options.onClose.call(), D();
                            break;
                        case google.ima.AdEvent.Type.AD_ERROR:
                            t.options.onError.call(), D()
                    }
                }

                function A(e) {
                    t.options.onError.call(), t.options.onFinish.call(), console.log(e.getError()), i && i.destroy()
                }

                function O() {
                    f.removeEventListener("ended", x), f.pause()
                }

                function M() {
                    f.addEventListener("ended", x), f.play()
                }
                ...
                function D() {
                    e(window).off("orientationchange", g), c === !1 && (c = !0, t.options.onFinish.call())
                }
                var i, s, o, u, a, f, l = !1,
                    c = !1,
                    h = {
        ...
        }), define("views/dfp", ["zepto", "underscore", "backbone", "models/gads", "text!templates/advertisement/dfp.html", "text!templates/advertisement/portaladvertisement.html", "text!templates/advertisement/play.html", "utils/url", "utils/debug.message", "utils/user.agent"], function(e, t, n, r, i, s, o, u, a, f) {
            var l = new u,
                c = new a,
                h = n.View.extend({
                    type: "interstitial",
                    ...
                    initialize: function(e) {
                        ...
                        r.src = "https://imasdk.googleapis.com/js/sdkloader/ima3.js", document.body.appendChild(r), r.onload = function() {
                            c.setMessage("Advertisement initialized")
                        }
                    },
                    _close: function() {
                        this.mode === "PORTAL" && e("iframe#booster-advertisement-popup").remove(), this.mode === "BUILTIN" && (e("#GADS_adpreroll").remove(), e("#booster-play-ads").remove()), this.callback != undefined && this.callback.call()
                    },
                    render: function() {
                        var n = l.buildProtocolRelativeURL(l.getURLParameter("bm.source")),
                            r = l.getURLParameter("bm.gameid"),
                            o = null;
                        this.mode === "PORTAL" ? (c.setMessage("Advertisement shown with bm.source & bm.gameid present in the url"), o = t.template(s, {
                            source: n,
                            bmGameId: r,
                            bmChannelId: this.channelID
                        })) : this.mode === "BUILTIN" && (c.setMessage("Advertisement will be should as BUILTIN mode"), o = t.template(i, {})), e("body").append(o)
                    },
                    showAdvertising: function(t) {
                        if (t != undefined) {
                            ...
                            this.shownOnce || (this.startDate = n ? this.initDate + n : 0, this.shownOnce = !0), this.interval = i
                        }
                        if (!this.isAdReady()) {
                            this.callback.call();
                            return
                        }
                        window.onAdDisplay && window.onAdDisplay(), this.render();
                        if (this.mode === "BUILTIN") {
                            var s = this,
                                o = l.buildProtocolRelativeURL(l.getURLParameter("bm.source")),
                                u = l.getURLParameter("bm.gameid"),
                                a = this.buildGadObj();
                            a.gameId = window.__gameCode || "null", r.init(a)
                    ...
                    showRewardingVideoAd: function(t) {
                        ...
                        window.onAdDisplay(), this.render();
                        if (this.mode === "BUILTIN") {
                            var s = this,
                                o = l.buildProtocolRelativeURL(l.getURLParameter("bm.source")),
                                u = this.buildGadObj();
                    ...
                    showPlayAdvertising: function(n) {
                        var r = new f,
                            i = this;
                        if (!r.isMobile() && !r.isIPad() && !r.isAndroid()) return this.showAdvertising(n);
                        if (!this.isAdReady()) return this.showAdvertising(n);
                        var s = t.template(o)();
                        e("body").append(s).children("#booster-play-ads").on("click", function() {
                            e("#booster-play-ads").remove(), i.showAdvertising(n)
                        })
                    },
                    buildGadObj: function() {
                        var e = this,
                            t = {
                                ...
                                gameSource: l.getURLParameter("bm.source"),
                                onFinish: function() {
                        ...
                        return this.channel_name && (t.channel_name = this.channel_name), this.channel_type && (t.channel_type = this.channel_type), t
                    },
                    isAdReady: function() {
                        var e = Date.now(),
                            t = this.startDate < e;
            ...
            var r = new n,
                i = e.Model.extend({
                    ...
                    redirect: function() {
                        var e = new t,
                            n = this.bmsource;
                        window.onMoreGames && window.onMoreGames(), n === "null" ? (n = "coolgames.com", window.top.location = e.buildProtocolRelativeURL(n)) : window.top.location = e.buildProtocolRelativeURL(n)
                    }
                });
            return i
        ...
        }), require(["zepto", "booster", "models/analytics", "views/booster.tab", "views/highscore.frame", "magnificpopup", "views/dfp", "models/moregames.model", "models/savestate.model", "views/stateapi", "views/freemium.frame"], function(e, t, n, r, i, s, o, u, a, f, l) {
            e(function(e) {
                window.Booster = window.Booster || {}, window.Booster.Init = t, window.Booster.Community = r, window.Booster.Score = i, window.Booster.Analytics = n, window.Booster.Moregames = u, window.Booster.Savestate = a, window.Booster.StateApi = f, window.Booster.Ad = o, window.Booster.Freemium = l, window.Booster.ready.call()
            })
        }), define("all", function() {})
})();